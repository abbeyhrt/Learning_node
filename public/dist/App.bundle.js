...
function autocomplete(input, latInput, lngInput) {
  ...
  // if enter is hit on the address filed, don't submit form
...
// In future, take day 21 of JS30 to learn about how to make the lat and long dynamic
...
var _templateObject = _taggedTemplateLiteral(['<div class="search__result">No results for ', ' found!</div>'], ['<div class="search__result">No results for ', ' found!</div>']);
...
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    _axios2.default.get('/api/search?q=' + this.value).then(function (res) {
      ...
      searchResults.innerHTML = _dompurify2.default.sanitize(_templateObject, _this.value);
    }).catch(function (err) {
      console.error(err);
    });
  });
